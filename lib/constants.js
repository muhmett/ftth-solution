...
// Mouvements de stock. Deux emplacements par société : le dépôt et le véhicule
// de chaque équipe ; le sens du mouvement découle du type.
export const MOVEMENT_KINDS = {
  ENTREE: { label: 'Livraison reçue', help: 'Entrée en dépôt', color: 'bg-green-100 text-green-800' },
  ATTRIBUTION: { label: 'Attribution à une équipe', help: 'Dépôt → véhicule', color: 'bg-sky-100 text-sky-800' },
  CONSOMMATION: { label: 'Consommation', help: 'Posé chez le client', color: 'bg-orange-100 text-orange-800' },
  RETOUR: { label: 'Retour au dépôt', help: 'Véhicule → dépôt', color: 'bg-indigo-100 text-indigo-800' },
  PERTE: { label: 'Perte / casse', help: 'Sortie sans intervention', color: 'bg-red-100 text-red-800' },
  AJUSTEMENT: { label: "Ajustement d'inventaire", help: 'Correction après comptage', color: 'bg-gray-100 text-gray-700' },
};
